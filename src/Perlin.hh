...
public:
    ...
    double eval(const Point3 &p);


    //Use the permutations table
    int permute(int x, int y, int z);

    static const unsigned tableSize = 256;
    unsigned tableSizeMask = tableSize - 1;
    std::array<Vector3, tableSize> gradients;
    //Original permutation table used from ken perlin; duplicated to have 512 elements
    std::array<int, tableSize * 2> permutations = { 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36,
